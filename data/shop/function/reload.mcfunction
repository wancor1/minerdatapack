...
# インベントリ内の検知用アイテムをclear
    ...
    execute if items entity @s container.* #shop:items_for_sale store result storage shop: menu.slot1 int 1 run data get entity @s Inventory[{components:{"minecraft:custom_data":{panel:"1"}}}].Slot
