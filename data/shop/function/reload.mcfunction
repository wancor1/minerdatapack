...
# インベントリ内の検知用アイテムをclear
    ...
    execute if items entity @s container.* minecraft:book[custom_data~{panel:"0"}] store result storage shop: menu.slot0 int 1 run data get entity @s Inventory[{components:{"minecraft:custom_data":{panel:"0"}}}].Slot
    ...
    execute if items entity @s container.* minecraft:gold_ingot[custom_data={menu:"invp",panel:"3"}] store result storage shop: menu.slot int 1 run data get entity @s Inventory[{components:{"minecraft:custom_data":{menu:"invp",panel:"3"}}}].Slot
