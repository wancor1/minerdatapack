...
# オフハンド・カーソルの検知用アイテムをclear
    execute if items entity @s weapon.offhand #shop:invpanelitem[custom_data~{menu:"shop"}] run item replace entity @s weapon.offhand with air
    #execute if items entity @s weapon.offhand #shop:invpanelitem[custom_data={menu:"shop",panel:"1"}] run item replace entity @s weapon.offhand with air
    #execute if items entity @s weapon.offhand #shop:invpanelitem[custom_data={menu:"shop",panel:"2"}] run item replace entity @s weapon.offhand with air
    #execute if items entity @s weapon.offhand #shop:invpanelitem[custom_data={menu:"shop",panel:"3"}] run item replace entity @s weapon.offhand with air
    execute if items entity @s player.cursor #shop:invpanelitem[custom_data~{menu:"shop"}] run item replace entity @s player.cursor with air
    #execute if items entity @s player.cursor #shop:invpanelitem[custom_data={menu:"shop",panel:"1"}] run item replace entity @s player.cursor with air
    #execute if items entity @s player.cursor #shop:invpanelitem[custom_data={menu:"shop",panel:"2"}] run item replace entity @s player.cursor with air
    #execute if items entity @s player.cursor #shop:invpanelitem[custom_data={menu:"shop",panel:"3"}] run item replace entity @s player.cursor with air

    execute if items entity @s weapon.offhand #shop:items_for_sale[custom_data~{shop:"true"}] run item replace entity @s weapon.offhand with air
    execute if items entity @s player.cursor #shop:items_for_sale[custom_data~{shop:"true"}] run item replace entity @s player.cursor with air
    ...
    #execute if items entity @s weapon.offhand minecraft:book[custom_data={menu:"sell",panel:"0"}] run item replace entity @s weapon.offhand with air
    #execute if items entity @s weapon.offhand minecraft:book[custom_data={menu:"shop",panel:"0"}] run item replace entity @s weapon.offhand with air
    ...
    #execute if items entity @s player.cursor minecraft:book[custom_data={menu:"sell",panel:"0"}] run item replace entity @s player.cursor with air
    #execute if items entity @s player.cursor minecraft:book[custom_data={menu:"shop",panel:"0"}] run item replace entity @s player.cursor with air

# インベントリ内の検知用アイテムをclear
    data modify storage shop: menu set value {slot0:53,slot1:53,slot2:53,slot3:53,slot4:53,slot5:53,slot6:53}
    execute if items entity @s container.* minecraft:book[custom_data={menu:"invp",panel:"0"}] store result storage shop: menu.slot0 int 1 run data get entity @s Inventory[{components:{"minecraft:custom_data":{menu:"invp",panel:"0"}}}].Slot
    execute if items entity @s container.* minecraft:book[custom_data={menu:"sell",panel:"0"}] store result storage shop: menu.slot4 int 1 run data get entity @s Inventory[{components:{"minecraft:custom_data":{menu:"sell",panel:"0"}}}].Slot
    execute if items entity @s container.* minecraft:book[custom_data={menu:"shop",panel:"0"}] store result storage shop: menu.slot5 int 1 run data get entity @s Inventory[{components:{"minecraft:custom_data":{menu:"shop",panel:"0"}}}].Slot
    ...
    execute if items entity @s container.* minecraft:gold_ingot[custom_data={menu:"invp",panel:"3"}] store result storage shop: menu.slot6 int 1 run data get entity @s Inventory[{components:{"minecraft:custom_data":{menu:"invp",panel:"3"}}}].Slot
