...
# オフハンド・カーソルの検知用アイテムをclear
    ...
    #execute if items entity @s weapon.offhand #sell:sellpanelitem[custom_data={menu:"sell",panel:"1"}] run item replace entity @s weapon.offhand with air
    #execute if items entity @s weapon.offhand #sell:sellpanelitem[custom_data={menu:"sell",panel:"2"}] run item replace entity @s weapon.offhand with air
    #execute if items entity @s weapon.offhand #sell:sellpanelitem[custom_data={menu:"sell",panel:"3"}] run item replace entity @s weapon.offhand with air
    ...
    #execute if items entity @s player.cursor #sell:sellpanelitem[custom_data={menu:"sell",panel:"1"}] run item replace entity @s player.cursor with air
    #execute if items entity @s player.cursor #sell:sellpanelitem[custom_data={menu:"sell",panel:"2"}] run item replace entity @s player.cursor with air
    #execute if items entity @s player.cursor #sell:sellpanelitem[custom_data={menu:"sell",panel:"3"}] run item replace entity @s player.cursor with air
