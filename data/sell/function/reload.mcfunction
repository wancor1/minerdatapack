...
# インベントリ内の検知用アイテムをclear
    ...
    execute if items entity @s container.* minecraft:book[custom_data={menu:"invp",panel:"0"}] store result storage sell: menu.slot0 int 1 run data get entity @s Inventory[{components:{"minecraft:custom_data":{menu:"invp",panel:"0"}}}].Slot
