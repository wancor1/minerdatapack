# メニュークリック検知
    ...
    execute unless items entity @s player.crafting.3 #menu:invpanelitem[custom_data={menu:"invp",panel:"3"}] if items entity @s player.crafting.0 #menu:invpanelitem[custom_data={menu:"invp",panel:"0"}] if items entity @s player.crafting.1 #menu:invpanelitem[custom_data={menu:"invp",panel:"1"}] if items entity @s player.crafting.2 #menu:invpanelitem[custom_data={menu:"invp",panel:"2"}] run function menu:click/none3
